...
//
// NO VIEW-STATE LABEL. This preview carried a "Day view" caption beside the
// date. The calendar's own toggle offers exactly Week and Month
// (app/(app)/calendar/ViewToggle.tsx lines 41-42), and the single-day column
// exists only under `md:hidden` (CalendarMobileDayView.tsx line 147) — so on
// the DESKTOP browser frame this preview depicts, that caption named a state a
// visitor cannot select. A caption is not worth implying an affordance that is
// not there, and the obvious replacement (a count of the day's appointments)
// would be exactly the invented analytic the line above forbids. The date
// heading carries the context on its own.
