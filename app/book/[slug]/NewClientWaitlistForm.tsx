...
//
// This component is PRESENTATION ONLY. It is reached because the server
// rendered `newClientWaitlistEnabled`, and the submit it drives re-verifies
// the feature server-side from the server-resolved studio. A stale tab, a
// forged post or modified client JavaScript cannot book around it: the public
// booking action carries its own independent gate.
//
...
// booking path and are one click away via the escape link. Nothing here
// exposes utilization, capacity, queue size, lead times, conversion rates or
// practitioner workload. Nothing here promises a date, a position, priority or
// acceptance.
//
// Uses the public booking page's existing design language (the beige card, the
// underlined-field form, the uppercase CTA) rather than introducing a new one.
// ===========================================================================
