...
| Waitlist | **Redeemed-but-unbooked exit** (#741 carrying #747) | Merged | ✅ 0200 + 0201 applied/frozen | Deployed | Enabled with WAIT surface | ✅ release smoke / automated evidence; Willow real use not established | ❌ pending | #741/#747 release evidence; 0201 live command no longer scans appointments | Gives the operator an honest exit after redemption without inventing appointment causality. |
| Waitlist | **Fixed normal invitation opportunity — 48h** (#748) | Merged | no migration | Deployed | Enabled | ✅ release evidence; Willow real invite exercise not established | ❌ pending | `lib/waitlist/invitation-window.ts`; #748 exact-head gate | Default changed 72→48; configurable bound 1..168 remains. WAIT-specific 24h reminder still missing. |
