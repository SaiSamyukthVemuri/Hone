...
notification email accepted by the provider and delivered to the studio's configured
`studios.owner_email`. Durable queue, invitations and automatic release are **not built**.
