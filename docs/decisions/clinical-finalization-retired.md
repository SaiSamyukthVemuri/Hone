...
| **Enforcement status** | **LIVE.** 0159 was applied and verified in production **2026-07-30T13:25:39Z–13:25:43Z** (SHA-256 `ea39fc36…f889f8`). The retirement is database-enforced; production migration max is **0159**. PR #482 merged and deployed 2026-07-30 (`d77d4434`), so the practitioner-facing source is gone too. Migration `0160` (immutable clinical lineage) was applied 2026-07-30 and is **not** a return of this capability — it pins record identity only and freezes no clinical content. |
