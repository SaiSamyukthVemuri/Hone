...
## Current production status (as of PR #163)
...
- At least 69 migrations applied. Most recent in-tree: `0069_appointment_referral_source.sql`. The next migration is `0070`. Always double-check the highest file in `supabase/migrations/` before assuming the count.
