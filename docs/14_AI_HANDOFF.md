...
## Current production status (as of PR #164)
...
- At least 70 migrations applied. Most recent in-tree: `0070_practitioner_notifications.sql`. The next migration is `0071`. Always double-check the highest file in `supabase/migrations/` before assuming the count.
