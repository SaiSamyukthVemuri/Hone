...
- **Still open after v1:** generated-types drift check against `lib/types/database.ts` (deferred: needs `supabase gen types` + a curated comparison to avoid noise), portal/anon token-route policies, storage policies, and browser E2E.
