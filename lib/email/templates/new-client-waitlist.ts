...
//      studio. In V1 this email IS the record: no durable queue, no client
//      row, no appointment row. The fixed, filterable "[HONE WAITLIST]"
//      subject prefix exists so the studio can label and route it.
//
...
// / a timestamp. Never clinical or health data, intake responses, payment
// data, capacity metrics, environment values, or another client's information
// — none of which this feature ever loads.
//
